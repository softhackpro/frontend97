  ...
  return (
    ...
    <div className="bg-gray-100 p-4 rounded-md w-full max-w-md mx-auto text-black">
      ...
      <div className="flex items-center justify-between bg-red-500 text-white p-3 rounded-md shadow-md relative">
        <div onClick={()=>setModalOpen(true)} className="w-1/3 text-center">
          <p className="font-bold">PLAYER</p>
          <p className="text-lg">1.95</p>
        </div>
        <div className="w-1/3 flex justify-center">
          <div onClick={()=>setModalOpen(true)} className="bg-green-500 w-16 h-16 flex items-center justify-center rounded-full text-white font-bold text-lg border-4 border-red-500">
            Tie
          </div>
        </div>
        <div onClick={()=>setModalOpen(true)} className="w-1/3 text-center">
      ...
      <div className="flex justify-between mt-4">
        <div onClick={()=>setModalOpen(true)} className="w-1/2 bg-red-500 text-white p-3 text-center rounded-md">
          <p className="font-bold">PLAYER PAIR</p>
          <p className="text-lg">11</p>
        </div>
        <div onClick={()=>setModalOpen(true)} className="w-1/2 bg-blue-500 text-white p-3 text-center rounded-md">
