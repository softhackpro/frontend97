    ...
    <div className="max-w-xl mx-auto bg-gray-200 p-4 rounded">
      ...
      <div className="mb-4">
        ...
        <div className="flex justify-between gap-4">
          <div className="bg-gradient-to-b from-red-600 to-red-800 rounded-full py-3 px-6 w-full flex justify-center items-center">
      ...
      <div className="flex gap-4 mb-4">
        ...
        <div className="w-1/2">
          ...
          <div className="flex gap-4">
            <div className="bg-gradient-to-b from-red-600 to-red-800 rounded-full py-3 w-full flex justify-center items-center">
      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-4">
          {/* Card Option 1 */}
          <div className="bg-gradient-to-b from-red-600 to-red-800 rounded-2xl py-3 px-4 flex flex-col items-center">
