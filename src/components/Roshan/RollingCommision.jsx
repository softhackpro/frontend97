          ...
          <table className="w-full border border-gray-300 text-sm text-gray-700">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-gray-300 px-4 py-2 text-left">Total Stack</th>
                <th className="border border-gray-300 px-4 py-2 text-left">Total Commision</th>
              </tr>
            </thead>
            <tbody>
              {data.map((item, index) => (
